...
1.  **vfork**
    ...
    *   参考实现关键：不执行copy\_vmspace，直接复用父进程页表
        ![\<img alt="" width="1146" height="504" data-attachment-key="2782MDYW" src="attachments/2782MDYW.png" ztype="zimage"> | 1146](attachments/2782MDYW.png)
